...
class DockerFromFile ( Host ):
    ...
    def __init__(
        ...
        * updateMemoryLimits(...)
        ...
        self.dimage = get_dimage(path)
        if not self.dimage:
            print("Your Dockerfile does not inherit from a base image!")
            exit(1)
        ...
        # convert Dockerfile into bytestream and supply directly to APIClient
        f = open(path)
