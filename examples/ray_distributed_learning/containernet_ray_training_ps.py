...
head_commands= "/bin/bash -c 'python ./code/training_scripts/ps_ray.py --data ; \
    /bin/bash code/utils/edit_hosts.sh ; ray start --head --node-ip-address 10.0.0.251 --disable-usage-stats ;exec /bin/bash'"
worker_commands = "/bin/bash -c 'python ./code/training_scripts/async_ps.py --data ; /bin/bash ./code/utils/edit_hosts.sh; /home/ray/anaconda3/bin/ray start --address 10.0.0.251:6379 --disable-usage-stats; exec /bin/bash'"
