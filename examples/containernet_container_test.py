...
d5 = net.addDocker('d4', dimage="containernet_example:ubuntu2004")
d6 = net.addDocker('d5', dimage="containernet_example:centos6")
d7 = net.addDocker('d6', dimage="containernet_example:centos7")
d8 = net.addDocker('d7', dimage="containernet_example:alpine3")
